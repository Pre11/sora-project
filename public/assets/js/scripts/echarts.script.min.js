...
$(document).ready(function () {
 ...
 if (echartElemBar) {
   ...
   echartBar.setOption({
     legend: {
       ...
       orient: 'horizontal',
       x: 'left',
       data: ['Total Cases', 'Resolved Cases']
     },
     grid: {
       left: '8px',
       right: '8px',
 ...
 if (echartElemBar) {
   var echartBar1 = echarts.init(echartElemBar);
 ...
 if (echartElemPie) {
   ...
   echartPie.setOption({
     color: ['#59ab40', '#7566b5', '#7d6cbb', '#8877bd', '#9181bd', '#6957af'],
     tooltip: {
       show: true,
       backgroundColor: 'rgba(0, 0, 0, .8)'
     },
 ...
 } // Chart in Dashboard version 1 // line charts
 ...
 if (echartElem3) {
  ...
  if (stackedPointerAreaElem) {
    ...
    stackedPointerArea.setOption({
      ...
      legend: {
        ...
        orient: 'horizontal',
        x: 'left',
        data: ['Pending Cases', 'Total Cases']
      },
      grid: {
        left: '12%',
        top: '12%',
      ...
      xAxis: {
        type: 'category',
        boundaryGap: false,
        data: ['Utility Projects', 'Technical Services Dept', 'Slurry Pipeline', 'Railway Siding', 'Plate Mill - O & M', 'Medical Department', 'Liaison & Public Relation', 'HR & Emplyoee Services', 'CSR', 'Coke Oven & Product Plant', 'CHP', 'Central HVAC & AC', 'CDQ Project', 'Bar Mill', 'Administration'],
        axisLabel: {
          formatter: '{value}',
          color: '#666',
          fontSize: 8,
      ...
      series: [{
        ...
        type: 'line',
        smooth: true,
        data: [9000, 5000, 4500, 500, 8000, 1200, 9300, 14500, 18000, 1400, 13500, 9500, 25000, 950, 12600],
        symbolSize: 8,
        lineStyle: {
          color: 'rgb(89 171 64)',
          opacity: 1,
        ...
        areaStyle: {
          normal: {
            color: {
              ...
              colorStops: [{
                offset: 0,
                color: 'rgba(89, 171, 64, 1)'
              }, {
                offset: 0.3,
                color: 'rgba(89, 171, 64, 0.7)'
              }, {
                offset: 1,
                color: 'rgba(89, 171, 64, 0)'
              }]
            }
          }
        }
        ...
        type: 'line',
        smooth: true,
        data: [1000, 15000, 9500, 7500, 8500, 12000, 9000, 14500, 8000, 14500, 1500, 19500, 25000, 1950, 18600],
        symbolSize: 8,
        lineStyle: {
  ...
  var stackedPointerAreaElem = document.getElementById('stackedPointerArea1');

  if (stackedPointerAreaElem) {
    var stackedPointerArea1 = echarts.init(stackedPointerAreaElem);
    stackedPointerArea1.setOption({
      tooltip: {
        trigger: 'axis',
        axisPointer: {
          animation: true
      ...
      series: [{
        ...
        type: 'line',
        smooth: true,
        data: [90, 500, 450, 500, 800, 120, 300, 145, 180, 140, 350, 500, 250, 50, 126],
        symbolSize: 8,
        lineStyle: {
          color: 'rgb(89 171 64)',
          opacity: 1,
        ...
        type: 'line',
        smooth: true,
        data: [1000, 150, 95, 750, 500, 120, 90, 450, 800, 145, 150, 195, 250, 195, 600],
        symbolSize: 8,
        lineStyle: {
          color: 'rgb(245 130 32)',
          opacity: 1,
